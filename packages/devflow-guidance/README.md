...
Loading a skill injects its asset body (about 9 KB for `devflow-workflow`, about 6 KB for `devflow-spec-authoring`, about 11 KB for `devflow-spec-bootstrap`) into that step.
