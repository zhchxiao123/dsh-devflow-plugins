/**
 * Shared local restatement of the Harness right-Sidebar contract.
 *
 * This declaration matches devflow-ui so both optional browser plugins can be
 * loaded together without competing Cordis or slot augmentations. Automation
 * consumes the registry and visible/expanded facts; the shared resource-action
 * declaration also serves Devflow. Neither plugin imports the other at runtime.
 *
